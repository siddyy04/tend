...
class LiteRtPromptBuilder {
  ...
  String _buildUserPrompt({
    ...
    buffer.writeln(
      ...
      'If the note does not contain at least one explicit person and a stable '
      'memory or relationship fact, produce no function calls. '
      'Never invent a memory simply to satisfy the tool. '
      'Never emit placeholder values such as N/A, None, Unknown, or "-". '
      'Returning zero memories is acceptable and preferred over fabrication '
      '(e.g. a bare name like "Emily", a lone word like "Yesterday", or a '
      'document with no personal/relationship facts is not enough). '
